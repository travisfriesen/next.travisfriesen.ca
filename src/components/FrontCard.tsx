export const FrontCard = () => {
    return (
        <div className={`w-screen h-screen min-h-[720px] flex`}>
            <div
                className="flex bg-green-80 dark:bg-green-20 bg-linear-to-tr from-green-90 to-green-50 rounded-lg h-[95vh] w-[95vw] min-h-[700px] m-auto">
